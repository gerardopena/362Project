...
def add_to_cart(request, **kwargs):
    ...
    user_profile = get_object_or_404(Account.object, pk=Account.object.id())
    #user_profile = Account.get_email_field_name()
    # filter products by id
    #user_profile = Account.get_email_field_name()
    flights = Flight.objects.filter(id=kwargs.get('item_id', "")).first()
...
def delete_from_cart(request, item_id):
    ...
    return redirect(reverse('cart:cart_summary.html'))
